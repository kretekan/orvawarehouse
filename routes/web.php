...
Route::group(['middleware' => 'userlogin'], function () {
    ...
    Route::middleware(['checkRoleUser:/barang-masuk,submenu'])->group(function () {
        ...
        Route::get('/barang-masuk', [BarangController::class, 'formMasuk'])->name('barang.masuk.form');
        Route::post('/barang-masuk/simpan', [BarangController::class, 'simpanMasuk'])->name('barang.masuk.simpan');
    });
    ...
    Route::middleware(['checkRoleUser:/lap-barang-masuk,submenu'])->group(function () {
        ...
        Route::get('/barang-keluar', [BarangController::class, 'formKeluar'])->name('barang.keluar.form');
        Route::post('/barang-keluar/simpan', [BarangController::class, 'simpanKeluar'])->name('barang.keluar.simpan');
    });
